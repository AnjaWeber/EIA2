...
(function (BeachSceneAnja) {
    ...
    function drawSky(_position) {
        ...
        crc2.closePath();
        var gradient = crc2.createLinearGradient(_position.x + 0, _position.y + 0, _position.x + 0, _position.y + 200);
    ...
    function drawSea(_position) {
        ...
        crc2.lineTo(_position.x + 800, _position.y);
        crc2.closePath();
        var gradient = crc2.createLinearGradient(_position.x + 0, _position.y + 0, _position.x + 0, _position.y + 300);
    ...
    function drawSun(_position) {
        ...
        var gradient = crc2.createRadialGradient(_position.x, _position.y, 75, _position.x, _position.y, 150);
    ...
    function drawBoat(_position, _boatColor) {
        crc2.beginPath();
